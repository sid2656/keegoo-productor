 ...
 * @author sid
 */
public class PushGroupMsgThreadManager extends AbsThread {

	private static final Logger logger = LoggerFactory.getLogger(PushGroupMsgThreadManager.class);

	static PushGroupMsgThreadManager obj;

	public static PushGroupMsgThreadManager getInstance() {
		if (obj == null)
			obj = new PushGroupMsgThreadManager();
		return obj;
	}
	...
	public PushGroupMsgThreadManager() {
